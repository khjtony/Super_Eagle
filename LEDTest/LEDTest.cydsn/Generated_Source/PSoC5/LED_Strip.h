...
#define LED_Strip_INTERNAL_CLOCK             (0u)
...
#define LED_Strip_TX_BUFFER_SIZE             (4u)
#define LED_Strip_RX_BUFFER_SIZE             (4u)
#define LED_Strip_INTERNAL_TX_INT_ENABLED    (0u)
#define LED_Strip_INTERNAL_RX_INT_ENABLED    (0u)
...
#define LED_Strip_INT_ON_TX_NOT_FULL ((uint8) (0u << \
...
#define LED_Strip_INT_ON_RX_NOT_EMPTY    ((uint8) (0u << \
