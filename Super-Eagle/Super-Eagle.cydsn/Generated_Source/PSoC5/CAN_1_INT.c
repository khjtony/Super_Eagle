            ...
            if ((CY_GET_REG16((reg16 *) &CAN_1_BUF_SR_REG.byte[0u]) & shift) == shift)
            {
                    ...
                    CAN_1_RX_INT_ENABLE_MASK)
                {
                    if ((CAN_1_RX_MAILBOX_TYPE & shift) == shift)
                    {
                        ...
                        switch(i)
                        {
							case 0u : CAN_1_ReceiveMsgbms_temp();
							break;
							case 1u : CAN_1_ReceiveMsgbms_volt();
							break;
							case 2u : CAN_1_ReceiveMsgbms_status();
							break;
							case 3u : CAN_1_ReceiveMsgbms_current();
							break;
							case 4u : CAN_1_ReceiveMsgthrottle();
							break;
							case 5u : CAN_1_ReceiveMsgbrake();
							break;
                            default:
                            break;
                        }
